...
public class LoginController {
    ...
    public String createFromForm(@ModelAttribute Usuario newUsuario) {
        if (usuarioRepository.findByEmail(newUsuario.getEmail()).isPresent()) {
        ...
        return "redirect:/iniciar-sesion?exito";
    }
}
